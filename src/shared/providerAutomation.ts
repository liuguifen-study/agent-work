...
const CONTEXT_COMMANDS: Record<AgentProvider, ProviderContextCommands> = {
  ...
  // DeepSeek Harness runs here through `dsh --profile headless`: one task,
  // one final answer, then the process exits. There is no live terminal prompt
  // to compact, clear, or safely receive a queued command.
  deepseek: NO_CONTEXT_COMMANDS,
